...
/**
 * Created by gorkem on 04.05.2017.
 */
public class GuiceSubclassMatcher<T extends TypeLiteral<?>> extends AbstractMatcher<T> {
    ...
    /** Compare types T against the types of the class passed to the constructor. */
    ...
    private static boolean typeIsSubtypeOf(TypeLiteral<?> subtype, TypeLiteral<?> supertype) {
        ...
        // Now find the generic ancestor (if any) which is based on non-generic types superRawType.
